...
const Cart = () => {
  ...
  const getCart = () => {
    ...
    for (const key in cartItems) {
      ...
      if (product) {
        product.quantity = cartItems[key]?.quantity || 0;
    ...
    try {
      ...
      if (paymentOption === "COD") {
        ...
        if (data.success) {
          ...
          // Clear cart by calling the backend to update cart
          try {
  ...
  return products.length > 0 ? (
                  ...
                  <div>
                    ...
                    <div className="font-normal text-gray-500/70">
                      ...
                      <div className="flex items-center">
                        ...
                        >
                          {Array(
                            Math.max(cartItems[product._id]?.quantity || 0, 9)
                          )
                            .fill("")
                            .map((_, index) => (
    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="text-center">
        <h2 className="text-2xl font-medium text-gray-500 mb-4">Loading...</h2>
        <p className="text-gray-400">Please wait while we load the products</p>
      </div>
    </div>
  );
};
